...
Outputs are written to `paper_outputs/hyperrectangle_review_20260825b/`. The builder refuses to overwrite an existing package and writes a SHA-256 manifest.
