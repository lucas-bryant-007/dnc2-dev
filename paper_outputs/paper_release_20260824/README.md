# Audited paper figure release: paper_release_20260824
...
rebuilt from the post-eval-fix artifacts pinned by `configs/paper_release_20260824.json`.
...
```powershell
python -m analysis.build_paper_release --config configs/paper_release_20260824.json
```
